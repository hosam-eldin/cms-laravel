      ...
      <div class="container text-center">
         ...
         <div class="row h-100">
            <div class="col-lg-8 mx-auto align-self-center">
               ...
               <h1 class="display-4 mt-7 mb-8">{{ $post->category->title }}</h1>
               <p><span class="opacity-70 mr-1">By</span> <a class="text-white" href="#">{{ $post->user->name }}</a>
               </p>
               <p><img class="avatar avatar-sm" src="{{ $post->user->gravatar(60) }}" alt="{{ $post->user->name }}">
               </p>
               ...
               <div class="col-lg-8 mx-auto">
                  ...
                  <script>
                     ...
                     (function() { // DON'T EDIT BELOW THIS LINE
                        ...
                        s.src = 'https://sass-blog-uvt0xjmuln.disqus.com/embed.js';
