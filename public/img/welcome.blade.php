   ...
   <nav class="navbar navbar-expand-lg navbar-light navbar-stick-dark" data-navbar="sticky">
      <div class="container">
         ...
         {{-- <section class="navbar-mobile">
            <span class="navbar-driver d-mobile-none">
         ...
         <div class="container">
            ...
            <div class="col-md-4 col-xl-3">
               <div class="sidebar px-4 py-md-0">
                  ...
                  <p class="small-3">TheSaaS is a responsive, professional, and multipurpose SaaS, Software, Startup
                     and WebApp landing template powered by Bootstrap 4. TheSaaS is a powerful and super flexible
                     tool for any kind of landing pages.</p>
